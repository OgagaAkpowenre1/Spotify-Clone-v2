...
const TopChartCard = ({
  ...
  <div className="py-2 p-4 rounded-lg mb-2 w-full flex flex-row items-center hover:bg-[#4c426e] cursor-pointer">
    ...
    <div className="flex flex-1 justify-between flex-row items-center">
      <img
        ...
        alt={song?.attributes?.name || "cover art"}
      ...
      <div className="w-full flex flex-col mt-8">
        ...
        >
          {topPlays?.map((song, index) => (
            ...
            >
              <Link
                to={`/artists${song?.relationships?.artists?.data[0]?.href}`}
              >
                <img
                  src={song?.attributes?.artwork?.url}
                  alt=""
